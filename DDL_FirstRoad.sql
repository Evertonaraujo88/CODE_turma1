...
CREATE TABLE tb_Usuarios(
	Id_usuario BINARY(60) NOT NULL,
    nomeUsuario VARCHAR(255) NOT NULL,
    email VARCHAR (100) NOT NULL UNIQUE,
    senha VARCHAR (60) NOT NULL,
    nif INT NOT NULL UNIQUE,
    dataNascimento DATE NOT NULL,
    Id_tipoUsuario BINARY(60)NOT NULL,
	Id_unidade BINARY(60)NOT NULL,
	Id_cargo BINARY(60) NOT NULL,
        PRIMARY KEY(Id_usuario),
    FOREIGN KEY(Id_tipoUsuario) REFERENCES tb_TiposUsuario(Id_tipoUsuario),
    FOREIGN KEY(Id_unidade) REFERENCES tb_Usuarios(Id_usuario),
    FOREIGN KEY(Id_cargo) REFERENCES tb_Cargo(Id_cargo)
);

CREATE TABLE tb_UnidadesOrganizacionais(
	Id_uo BINARY(16) NOT NULL,
    nomeDepartament VARCHAR (200)NOT NULL,
